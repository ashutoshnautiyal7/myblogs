...
//  for this first we have to rename this file and change this as a slug // page.js --> [trendingid].js 
...
import getTrending from "../../lib/helper2"
...
export async function getStaticProps( { params } ){
    const posts = await getTrending(params.trendingid)
