...
// this {trendingid} file is a slug or we can say a variable
...
export default function handler(req, res) {
    ...
    const {trendingid} = req.query;   // note the variable and the filename(array).js  are having the same name
